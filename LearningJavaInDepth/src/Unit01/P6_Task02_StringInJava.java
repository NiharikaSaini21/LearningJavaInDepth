...
class StringInJava {
	void StringDefinition() {
		 ...
		 * The String pool helps is reusing the strings.
	...
	void charAndString() {
		...
		/*
		 * Join two java strings - +' can be used to append two strings together to form a 
